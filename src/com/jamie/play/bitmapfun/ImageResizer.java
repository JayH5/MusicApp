...
public class ImageResizer {
    ...
    public Bitmap getBitmapFromFile(File file) {
    	return decodeSampledBitmapFromFile(file.toString(), mImageWidth, 
    			mImageHeight);
    }
    
    public Bitmap getBitmapFromContentUri(Uri contentUri) {
    	return decodeSampledBitmapFromContentUri(mContext.getContentResolver(), 
