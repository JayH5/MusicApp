...
public abstract class ImageWorker {
     ...
     */
    protected abstract Bitmap processBitmap(Bundle data);
    ...
    public static void cancelWork(ImageView imageView) {
        ...
        if (bitmapWorkerTask != null) {
            ...
            if (BuildConfig.DEBUG) {
                final Object bitmapKey = bitmapWorkerTask.key;
                Log.d(TAG, "cancelWork - cancelled work for " + bitmapKey);
            }
        }
    }
     ...
     */
    private class BitmapWorkerTask extends AsyncTask<Bundle, Void, Bitmap> {
        private String key;
